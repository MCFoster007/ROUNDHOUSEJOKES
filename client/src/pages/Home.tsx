  ...
  return (
    <>
      ...
      <div className="button-group">
        <button onClick={() => handleButtonWithSound("newJoke", newJokeSound)}>
          New Joke
        </button>
        <button
          onClick={() => handleButtonWithSound("chuckJokes", chuckJokeSound)}
        >
          Chuck Joke
        </button>
      ...
      <div className="button-save">
        <button
          onClick={() =>
            console.log("Save Joke functionality not implemented yet.")
          }
        >
          Save Joke!
        </button>
